...
lol_get( 
	...
	int	i )
{
	// this is probably wrong... returning a reference to a static empty list,
	// likely means that the list will get modified later :-/
	return i < lol->count ? lol->list[i] : empty_list;
}
